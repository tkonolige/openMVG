...
int main(int argc, char **argv)
{
  ...
  cmd.add( make_switch('A', "adjust_usage") );
  ...
  try {
    ...
    << "[-A|--adjust_usage] Disable usage of bundle adjuster\n"
  ...
  b_use_adjust = cmd.used('A');
  sfmEngine.Set_Use_Adjust(b_use_adjust);
